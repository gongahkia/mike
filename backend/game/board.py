...
class ShogiBoard:
    ...
    def is_in_check(self, player: Player, check_validity: bool = True) -> bool:
        ...
        for row in range(9):
            for col in range(9):
                ...
                if piece and piece.player == opponent:
                    # Use check_validity=False to avoid recursion
                    moves = piece.get_moves(row, col, self, check_validity=False)
            ...
            for col in range(9):
                ...
                if piece and piece.player == player:
                    ...
                    for move_row, move_col in moves:
                        ...
                        still_in_check = self.is_in_check(player, check_validity=False)
